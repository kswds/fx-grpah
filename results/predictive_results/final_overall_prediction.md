...
Evaluation setup:
- All baseline models use the same shared training objective for this comparison: the active directional core on non-USD targets only while our proposed model uses its training objective described in models_details.md.
